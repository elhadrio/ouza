...
public class IconLaoder {
	...
	public static final ImageIcon SAVEALL_ICON=chargeur.getIcon("saveAll.jpg");
	...
	public static final ImageIcon SELLECT_ALL_ICON=chargeur.getIcon("sellectALL.jpg");
	
	public static final ImageIcon PROJECT_ICON=chargeur.getIcon("project.jpg");
	
	public static final ImageIcon SOURCE_ICON=chargeur.getIcon("source.jpg");
	
	public static final ImageIcon PACKAGE_ICON=chargeur.getIcon("package.jpg");
	
	public static final ImageIcon CLASS_ICON=chargeur.getIcon("class.jpg");
	
	public static final ImageIcon INTERFACE_ICON=chargeur.getIcon("interface.jpg");
	...
	public static final ImageIcon WARNING_ICON=chargeur.getIcon("warning.jpg");
